...
replace (
	...
	k8s.io/component-helpers => k8s.io/component-helpers v0.18.4
	k8s.io/controller-manager => k8s.io/controller-manager v0.18.4
	...
	k8s.io/mount-utils => k8s.io/mount-utils v0.18.4
	k8s.io/pod-security-admission => k8s.io/pod-security-admission v0.18.4
